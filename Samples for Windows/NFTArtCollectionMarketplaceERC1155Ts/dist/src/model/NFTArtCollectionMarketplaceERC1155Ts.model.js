...
exports.Loyalty = exports.ArtCollection = exports.ArtCollectionMetadata = void 0;
...
tslib_1.__decorate([
    (0, decorators_1.ReadOnly)("erc1155+"),
    tslib_1.__metadata("design:type", String)
...
let Loyalty = class Loyalty extends ochain_model_1.OchainModel {
    constructor() {
        super(...arguments);
        this.assetType = "otoken";
    }
...
tslib_1.__decorate([
    ...
    (0, decorators_1.Validate)(yup
        ...
        .max(16)),
    tslib_1.__metadata("design:type", String)
], Loyalty.prototype, "tokenId", void 0);
tslib_1.__decorate([
    (0, decorators_1.ReadOnly)("loyalty"),
    tslib_1.__metadata("design:type", String)
], Loyalty.prototype, "tokenName", void 0);
tslib_1.__decorate([
    (0, decorators_1.Validate)(yup.string().trim().max(256)),
    tslib_1.__metadata("design:type", String)
], Loyalty.prototype, "tokenDesc", void 0);
tslib_1.__decorate([
    (0, decorators_1.ReadOnly)("erc1155+"),
    tslib_1.__metadata("design:type", String)
], Loyalty.prototype, "tokenStandard", void 0);
tslib_1.__decorate([
    (0, decorators_1.ReadOnly)("fungible"),
    tslib_1.__metadata("design:type", String)
], Loyalty.prototype, "tokenType", void 0);
tslib_1.__decorate([
    (0, decorators_1.ReadOnly)("fractional"),
    tslib_1.__metadata("design:type", String)
], Loyalty.prototype, "tokenUnit", void 0);
tslib_1.__decorate([
    (0, decorators_1.ReadOnly)(["divisible", "mintable", "transferable", "burnable", "roles"]),
    tslib_1.__metadata("design:type", Array)
], Loyalty.prototype, "behaviors", void 0);
tslib_1.__decorate([
    (0, decorators_1.ReadOnly)({ minter_role_name: "minter" }),
    tslib_1.__metadata("design:type", Object)
], Loyalty.prototype, "roles", void 0);
tslib_1.__decorate([
    (0, decorators_1.ReadOnly)({ max_mint_quantity: 10000 }),
    tslib_1.__metadata("design:type", Object)
], Loyalty.prototype, "mintable", void 0);
tslib_1.__decorate([
    (0, decorators_1.ReadOnly)({ decimal: 2 }),
    tslib_1.__metadata("design:type", Object)
], Loyalty.prototype, "divisible", void 0);
tslib_1.__decorate([
    (0, decorators_1.Validate)(yup.string()),
    tslib_1.__metadata("design:type", String)
], Loyalty.prototype, "currency_name", void 0);
tslib_1.__decorate([
    (0, decorators_1.Validate)(yup.number()),
    tslib_1.__metadata("design:type", Number)
], Loyalty.prototype, "token_to_currency_ratio", void 0);
Loyalty = tslib_1.__decorate([
    (0, decorators_1.Id)("tokenId")
], Loyalty);
exports.Loyalty = Loyalty;
//# sourceMappingURL=NFTArtCollectionMarketplaceERC1155Ts.model.js.map