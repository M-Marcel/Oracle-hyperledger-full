...
import (
	...
	"example.com/LoyaltyToken/lib/account"
	"example.com/LoyaltyToken/lib/admin"

	"example.com/LoyaltyToken/lib/trxcontext"
	. "example.com/LoyaltyToken/src/model"
)
...
func (t *Controller) InitializeLoyalTOKToken(asset LoyalTOK) (interface{}, error) {
...
func (t *Controller) UpdateLoyalTOKToken(asset LoyalTOK) (interface{}, error) {
...
func (t *Controller) CreateConsumerLoyalty(asset ConsumerLoyalty) (interface{}, error) {
	return t.Ctx.Model.Save(&asset)
}

func (t *Controller) GetConsumerLoyaltyById(id string) (ConsumerLoyalty, error) {
	var asset ConsumerLoyalty
	_, err := t.Ctx.Model.Get(id, &asset)
	return asset, err
}
func (t *Controller) UpdateConsumerLoyalty(asset ConsumerLoyalty) (interface{}, error) {
	return t.Ctx.Model.Update(&asset)
}
func (t *Controller) DeleteConsumerLoyalty(id string) (interface{}, error) {
	return t.Ctx.Model.Delete(id)
}
func (t *Controller) GetConsumerLoyaltyHistoryById(id string) (interface{}, error) {
	historyArray, err := t.Ctx.Model.GetHistoryById(id)
	return historyArray, err
}
func (t *Controller) GetConsumerLoyaltyByRange(startkey string, endKey string) ([]ConsumerLoyalty, error) {
	var assets []ConsumerLoyalty
...
func (t *Controller) CreateMerchantDetails(asset MerchantDetails) (interface{}, error) {
	return t.Ctx.Model.Save(&asset)
}

func (t *Controller) GetMerchantDetailsById(id string) (MerchantDetails, error) {
	var asset MerchantDetails
	_, err := t.Ctx.Model.Get(id, &asset)
	return asset, err
}
func (t *Controller) UpdateMerchantDetails(asset MerchantDetails) (interface{}, error) {
	return t.Ctx.Model.Update(&asset)
}
func (t *Controller) DeleteMerchantDetails(id string) (interface{}, error) {
	return t.Ctx.Model.Delete(id)
}
func (t *Controller) GetMerchantDetailsHistoryById(id string) (interface{}, error) {
	historyArray, err := t.Ctx.Model.GetHistoryById(id)
	return historyArray, err
}
func (t *Controller) GetMerchantDetailsByRange(startkey string, endKey string) ([]MerchantDetails, error) {
	var assets []MerchantDetails
	_, err := t.Ctx.Model.GetByRange(startkey, endKey, &assets)
	return assets, err
}
...
func (t *Controller) InitializeMerchant(MerchantID string, MerchantName string, MerchantType string, MerchantOrgID string, MerchantUserID string) (interface{}, error) {

	merchantaccount, err := t.Ctx.Account.CreateAccount(MerchantOrgID, MerchantUserID, "fungible")
	if err != nil {
		return nil, err
	}

	var asset = new(MerchantDetails)
	asset.Merchant_Id = MerchantID
	asset.Merchant_Name = MerchantName
	asset.Merchant_Type = MerchantType
	asset.Merchant_Org_Id = MerchantOrgID
	asset.Merchant_User_Id = MerchantUserID
	asset.Merchant_Account_Id = merchantaccount.AccountId
	asset.Merchant_Status = "active"

	merchant, err := t.CreateMerchantDetails(*asset)
	if err != nil {
		return merchant, err
	}
...
func (t *Controller) InitializeConsumer(ConsumerID string, ConsumerName string, ConsumerOrgID string, ConsumerUserID string) (interface{}, error) {

	merchantAccount, err := t.Ctx.Account.CreateAccount(ConsumerOrgID, ConsumerUserID, "fungible")
	if err != nil {
		return nil, err
	}

	var asset = new(ConsumerLoyalty)
	asset.Consumer_Id = ConsumerID
	asset.Consumer_Name = ConsumerName
	asset.Consumer_Org_Id = ConsumerOrgID
	asset.Consumer_User_Id = ConsumerUserID
	asset.Consumer_Account_Id = merchantAccount.AccountId
	asset.Accrued_Token_Quantity = 0
	asset.Redeemed_Token_Quantity = 0
	asset.Consumer_Status = "active"

	consumer, err := t.CreateConsumerLoyalty(*asset)
	if err != nil {
		return consumer, err
	}
	return consumer, nil
...
func (t *Controller) AssociateTokenToMerchantAccount(MerchantID string, LoyaltyTokenID string) (interface{}, error) {
	merchant, err := t.GetMerchantDetailsById(MerchantID)
	if err != nil {
		return nil, fmt.Errorf("error in getting merchant details  %s", err.Error())
	}
	merchantAssociation, err := t.AssociateTokenToAccount(merchant.Merchant_Account_Id, LoyaltyTokenID)
	if err != nil {
		return merchantAssociation, err
	}

	return merchantAssociation, err
}

func (t *Controller) AssociateTokenToConsumerAccount(MerchantID string, LoyaltyTokenID string) (interface{}, error) {
	consumer, err := t.GetConsumerLoyaltyById(MerchantID)
	if err != nil {
		return nil, fmt.Errorf("error in getting consumer details  %s", err.Error())
	}
	consumerAssociation, err := t.AssociateTokenToAccount(consumer.Consumer_Account_Id, LoyaltyTokenID)
	if err != nil {
		return nil, err
	}
	return consumerAssociation, err
}

func (t *Controller) RewardLoyaltyTokens(LoyaltyTokenID string, FromMerchantID string, ToConsumerID string, RewardTokenQuantity float64) (interface{}, error) {
	consumer, err := t.GetConsumerLoyaltyById(ToConsumerID)
	if err != nil {
		return nil, fmt.Errorf("error in getting customer details  %s", err.Error())
	}

	transfer, err := t.TransferTokens(LoyaltyTokenID, consumer.Consumer_Org_Id, consumer.Consumer_User_Id, RewardTokenQuantity)
	if err != nil {
		return transfer, err
	}

	consumer.Accrued_Token_Quantity = consumer.Accrued_Token_Quantity + RewardTokenQuantity
	updateconsumer, err := t.UpdateConsumerLoyalty(consumer)
	if err != nil {
		return updateconsumer, err
	}
	return `Rewarded loyalty tokens have been updated successfully`, nil
}

func (t *Controller) RedeemLoyaltyTokens(LoyaltyTokenID string, FromConsumerID string, ToMerchantID string, RedeemTokenQuantity float64) (interface{}, error) {

	consumer, err := t.GetConsumerLoyaltyById(FromConsumerID)
	if err != nil {
		return nil, fmt.Errorf("error in getting customer details  %s", err.Error())
	}

	merchant, err := t.GetMerchantDetailsById(ToMerchantID)
	if err != nil {
		return nil, fmt.Errorf("error in getting customer details  %s", err.Error())
	}

	transfer, err := t.TransferTokens(LoyaltyTokenID, merchant.Merchant_Org_Id, merchant.Merchant_User_Id, RedeemTokenQuantity)
	if err != nil {
		return transfer, err
	}

	consumer.Redeemed_Token_Quantity = consumer.Redeemed_Token_Quantity + RedeemTokenQuantity

	updateconsumer, err := t.UpdateConsumerLoyalty(consumer)
	if err != nil {
		return updateconsumer, err
	}
	updatemerchant, err := t.UpdateMerchantDetails(merchant)
	if err != nil {
		return updatemerchant, err
	}
	return `Redeemed loyalty tokens have been updated successfully`, nil
}
